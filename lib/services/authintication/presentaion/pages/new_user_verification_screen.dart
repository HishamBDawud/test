...
import 'package:cleanapp/services/authintication/presentaion/bloc/newUserVerification/new_verification_bloc.dart';
import 'package:cleanapp/services/authintication/presentaion/bloc/timer/timer_bloc.dart';
import 'package:cleanapp/services/authintication/presentaion/pages/new_password_screen.dart';
...
import '../bloc/newUserVerification/new_verification_event.dart';
import '../bloc/timer/timer_event.dart';
import '../bloc/timer/timer_state.dart';

class NewUserVerificationScreen extends StatefulWidget {
  final String username;
  const NewUserVerificationScreen({super.key, required this.username});

  @override
  State<NewUserVerificationScreen> createState() =>
      _NewUserVerificationScreenState();
}

class _NewUserVerificationScreenState extends State<NewUserVerificationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: BlocConsumer<NewVerificationBloc, NewVerificationState>(
  ...
  Widget verifyButton() {
    return BlocBuilder<NewVerificationBloc, NewVerificationState>(
        builder: (context, state) {
      return ElevatedButton(
        ...
        onPressed: () {
          context
              .read<NewVerificationBloc>()
              .add(OtpSubmitted(otp: myOtp, username: widget.username));
        },
      );
    });
  }
